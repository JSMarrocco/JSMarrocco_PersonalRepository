...
from mutations import random_mutation, point_mutation, node_mutation
...
class Genomes:
    ...
    def __init_new_genome(self, new_genome):
        # output_nodes = new_genome.nodeGenes.get_nodes_by_type(NodeType.OUTPUT)
        # for output_node in output_nodes:
        output_node = random.choice(new_genome.nodeGenes .get_nodes_by_type(NodeType.OUTPUT))
        input_node = random.choice(new_genome.nodeGenes.get_nodes_by_type(NodeType.INPUT))
